within MultiZoneOfficeSimpleAirMotor.TestCases;
model TestCase
  "Variable air volume flow system with terminal reheat and five thermal zones"
  extends Modelica.Icons.Example;
  import Modelica.Constants.pi;
  extends MultiZoneOfficeSimpleAirMotor.BaseClasses.PartialOpenLoop(
    ...
    fanSup(simMot(omegaRat(fixed=true, start=0)), mover(addPowerToMedium=false, mover(
  ...
  Modelica.Blocks.Math.Gain freBas(k=f_base)
                                         "Frequency base"
    annotation (Placement(transformation(extent={{382,-10},{362,10}})));
  Modelica.Blocks.Sources.RealExpression voltage(y=110)
    annotation (Placement(transformation(extent={{342,-320},{322,-300}})));
  Buildings.Utilities.IO.SignalExchange.Overwrite V(u(min=0, max=130),
      description="Supply voltage")
    annotation (Placement(transformation(extent={{276,-322},{256,-302}})));

  Buildings.Utilities.IO.SignalExchange.Overwrite TZonCorCooSet(u(min=273.15 + 20,
        max=273.15 + 26),
      description="Cooling setpoint for the core zone")
    annotation (Placement(transformation(extent={{494,130},{514,150}})));
  Buildings.Utilities.IO.SignalExchange.Overwrite TZonSouCooSet(u(min=273.15 + 20,
        max=273.15 + 26),
      description="Cooling setpoint for the south zone")
    annotation (Placement(transformation(extent={{620,130},{640,150}})));
  Buildings.Utilities.IO.SignalExchange.Overwrite TZonEasCooSet(u(min=273.15 + 20,
        max=273.15 + 26),
      description="Cooling setpoint for the east zone")
    annotation (Placement(transformation(extent={{780,160},{800,180}})));
  Buildings.Utilities.IO.SignalExchange.Overwrite TZonNorCooSet(u(min=273.15 + 20,
        max=273.15 + 26),
      description="Cooling setpoint for the north zone")
    annotation (Placement(transformation(extent={{976,160},{996,180}})));
  Buildings.Utilities.IO.SignalExchange.Overwrite TZonWesCooSet(u(min=273.15 + 20,
        max=273.15 + 26),
      description="Cooling setpoint for the west zone")
    annotation (Placement(transformation(extent={{1118,154},{1138,174}})));
equation

  connect(conAHU.ySupFanSpe, freBas.u) annotation (Line(points={{424,618.667},{
          462,618.667},{462,0},{384,0}},
                                       color={0,0,127}));
  connect(freBas.y, fanSup.f) annotation (Line(points={{361,0},{356,0},{356,-20},
          {301.2,-20},{301.2,-28}}, color={0,0,127}));

  connect(voltage.y, V.u) annotation (Line(points={{321,-310},{284,-310},{284,-314},
          {278,-312}}, color={0,0,127}));
  ...
  connect(TZonCorCooSet.y, conVAVCor.TZonCooSet) annotation (Line(points={{515,
          140},{524,140},{524,102},{528,102}}, color={0,0,127}));
  connect(TZonCorCooSet.u, TZonSet[1].TZonCooSet) annotation (Line(points={{492,
          140},{476,140},{476,202},{-78,202}}, color={0,0,127}));
  connect(TZonSouCooSet.y, conVAVSou.TZonCooSet) annotation (Line(points={{641,
          140},{660,140},{660,102},{700,102}}, color={0,0,127}));
  connect(TZonSouCooSet.u, TZonSet[2].TZonCooSet) annotation (Line(points={{618,
          140},{580,140},{580,202},{-78,202}}, color={0,0,127}));
  connect(TZonEasCooSet.y, conVAVEas.TZonCooSet) annotation (Line(points={{801,
          170},{840,170},{840,102},{878,102}}, color={0,0,127}));
  connect(TZonEasCooSet.u, TZonSet[3].TZonCooSet) annotation (Line(points={{778,
          170},{758,170},{758,202},{-78,202}}, color={0,0,127}));
  connect(TZonNorCooSet.y, conVAVNor.TZonCooSet) annotation (Line(points={{997,
          170},{1010,170},{1010,102},{1036,102}}, color={0,0,127}));
  connect(TZonNorCooSet.u, TZonSet[4].TZonCooSet) annotation (Line(points={{974,
          170},{946,170},{946,202},{-78,202}}, color={0,0,127}));
  connect(TZonWesCooSet.y, conVAVWes.TZonCooSet) annotation (Line(points={{1139,
          164},{1176,164},{1176,102},{1238,102}}, color={0,0,127}));
  connect(TZonWesCooSet.u, TZonSet[5].TZonCooSet) annotation (Line(points={{
          1116,164},{1096,164},{1096,202},{-78,202}}, color={0,0,127}));
  connect(V.y, fanSup.V) annotation (Line(points={{255,-312},{250,-312},{250,-12},
          {310.4,-12},{310.4,-28}}, color={0,0,127}));
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-380,-320},{1400,
            680}})),
    Documentation(info="<html>
<p>
This model is modified based on <a href=\"modelica://Buildings.Examples.VAVReheat.Guideline36\">
Buildings.Examples.VAVReheat.Guideline36.</a>
</p>
<p>We change the model of the supply fan into <a href=\"modelica://MultiZoneOfficeSimpleAirMotor.BaseClasses.MotorDevice.FlowMoverWithMotor\">MultiZoneOfficeSimpleAirMotor.BaseClasses.MotorDevice.FlowMoverWithMotor</a>.</p>
</html>", revisions="<html>
<ul>
<li>
June 21, 2022, by Sen Huang:<br/>
Replace the fan model with the one coupled with a motor model
</li>
<li>
...
This is for <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/2471\">issue #2471</a>.
    ...
    __Dymola_Commands(file=
          "modelica://MultiZoneOfficeSimpleAirMotor/Resources/Scripts/Dymola/Guideline36Motor.mos"
        "Simulate and plot"),
    experiment(
      StartTime=15638400,
      StopTime=15984000,
