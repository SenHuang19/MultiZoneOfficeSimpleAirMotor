...
partial model PartialOpenLoop
  ...
  parameter Modelica.SIunits.Temperature T_start=273.15+27
    "Start temperature";
  ...
  MotorDevice.FlowMoverWithMotor fanSup(
    redeclare package Medium = MediumA,
    per(pressure(V_flow={0,m_flow_nominal/1.2*2}, dp=2*{780 + 10 + dpBuiStaSet,
            0}), motorEfficiency(V_flow={0}, eta={1})),
    f_base=f_base) "Supply air fan"
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam=
        Modelica.Utilities.Files.loadResource("modelica://MultiZoneOfficeSimpleAirMotor/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos"),
...
public
  ...
  Buildings.Fluid.Sources.MassFlowSource_T souHeaCor(
    redeclare package Medium = MediumW,
    T=THotWatInl_nominal,
    use_m_flow_in=true,
    nPorts=1) "Source for core zone reheat coil" annotation (Placement(
        ...
        rotation=0,
        origin={540,38})));
  Buildings.Fluid.Sources.MassFlowSource_T souHeaSou(
    redeclare package Medium = MediumW,
    T=THotWatInl_nominal,
    use_m_flow_in=true,
    nPorts=1) "Source for south zone reheat coil" annotation (Placement(
        ...
        rotation=0,
        origin={722,36})));
  Buildings.Fluid.Sources.MassFlowSource_T souHeaEas(
    redeclare package Medium = MediumW,
    T=THotWatInl_nominal,
    use_m_flow_in=true,
    nPorts=1) "Source for east zone reheat coil" annotation (Placement(
        ...
        rotation=0,
        origin={896,36})));
  Buildings.Fluid.Sources.MassFlowSource_T souHeaNor(
    redeclare package Medium = MediumW,
    T=THotWatInl_nominal,
    use_m_flow_in=true,
    nPorts=1) "Source for north zone reheat coil" annotation (Placement(
        ...
        rotation=0,
        origin={1058,36})));
  Buildings.Fluid.Sources.MassFlowSource_T souHeaWes(
    redeclare package Medium = MediumW,
    T=THotWatInl_nominal,
    use_m_flow_in=true,
...
equation
  ...
  connect(splRetEas.port_3, flo.portsEas[2]) annotation (Line(
      points={{1002,10},{1002,120},{1065.06,120},{1065.06,513.333}},
      color={0,127,255},
      thickness=0.5));
  connect(splRetNor.port_3, flo.portsNor[2]) annotation (Line(
      points={{1152,10},{1152,214},{902.487,214},{902.487,575.667}},
      color={0,127,255},
      thickness=0.5));
  ...
  connect(cor.port_bAir, flo.portsCor[1]) annotation (Line(
      points={{590,62},{590,120},{895.357,120},{895.357,513.333}},
      color={0,127,255},
      thickness=0.5));
...
<p>
This model is modified based on <a href=\"modelica://Buildings.Examples.VAVReheat.BaseClasses.PartialOpenLoop\">Buildings.Examples.VAVReheat.BaseClasses.PartialOpenLoop</a>.
</p>
...
<ul>
<li>May 6, 2021, by David Blum:<br>Change to <span style=\"font-family: Courier New;\">from_dp=false</span> for all mixing box dampers.<br>This is for <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/2485\">issue #2485</a>. </li>
</ul>
</html>"));
end PartialOpenLoop;
